<template>
    <div class="sticky-bar" id="stickyBar">
        <p>Ready to test your hormones?</p>
        <a href="#hormone-packages" class="sticky-cta">Book Consultation<svg width="14" height="14" viewBox="0 0 24 24"
...
.sticky-bar {
    ...
    border-top: 2px solid var(--dls-color-sunshine);
    padding: 12px 60px;
    display: flex;
